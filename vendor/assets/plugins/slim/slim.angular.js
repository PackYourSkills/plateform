   ...
   */
		...
		value: function _applyTransforms(image, ready) {
			...
			transformCanvas(image, this._data.actions, function (transformedImage) {
				...
				if (_this19._options.forceSize || _this19._options.size && sizeDist(_this19._options.size, transformedImage) == 1) {
					outputImage = create('canvas');
					outputImage.width = _this19._options.size.width;
					outputImage.height = _this19._options.size.height;
					var ctx = outputImage.getContext('2d');
					ctx.drawImage(transformedImage, 0, 0, _this19._options.size.width, _this19._options.size.height);
				}

				// store output
				_this19._data.output.width = outputImage.width;
				_this19._data.output.height = outputImage.height;
				_this19._data.output.image = outputImage;
